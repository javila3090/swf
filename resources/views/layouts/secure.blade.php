        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-admin"></i> <span>ADMIN AREA</span></a>
                </div>
                ...
                <nav>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="javaasset:" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
