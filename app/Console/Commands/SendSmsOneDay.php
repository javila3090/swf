...
class SendSmsOneDay extends Command
{
    use Traits;
    /**
     ...
     * @var string
     */
    protected $signature = 'send:smsOneDay';
     ...
     * @var string
     */
    protected $description = 'Send one sms per day';
    ...
    {
        $orders=DB::table('orders')->where('id_frecuency',124)->where('id_status',1)->get();
