...
class SendSmsTwoHour extends Command
{
    use Traits;
    /**
     ...
     * @var string
     */
    protected $signature = 'send:smsTwoHour';
     ...
     * @var string
     */
    protected $description = 'Send two sms per hour';
    ...
    {
        $orders=DB::table('orders')->where('id_frecuency',2)->where('id_status',1)->get();
