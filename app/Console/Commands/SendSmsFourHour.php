...
class SendSmsFourHour extends Command
{
    use Traits;
    /**
     ...
     * @var string
     */
    protected $signature = 'send:smsFourHour';
     ...
     * @var string
     */
    protected $description = 'Send four sms per hour';
    ...
    {
        $orders=DB::table('orders')->where('id_frecuency',4)->where('id_status',1)->get();
